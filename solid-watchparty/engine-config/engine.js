const df_867_2 = new ((await import('@comunica/logger-void')).LoggerVoid)();
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_init__2_0_0_components_ActorInit_jsonld_ActorInit_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_context_preprocess__2_0_0_components_ActorContextPreprocess_jsonld_ActorContextPreprocess_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_hash_bindings__2_0_0_components_ActorHashBindings_jsonld_ActorHashBindings_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_query_operation__2_0_0_components_ActorOptimizeQueryOperation_jsonld_ActorOptimizeQueryOperation_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_parse__2_0_0_components_ActorQueryParse_jsonld_ActorQueryParse_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_result_serialize__2_0_0_components_ActorQueryResultSerialize_jsonld_ActorQueryResultSerialize_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_dereference__2_0_0_components_ActorDereference_jsonld_ActorDereference_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_dereference_rdf__2_0_0_components_ActorDereferenceRdf_jsonld_ActorDereferenceRdf_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join_entries_sort__2_0_0_components_ActorRdfJoinEntriesSort_jsonld_ActorRdfJoinEntriesSort_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join_selectivity__2_0_0_components_ActorRdfJoinSelectivity_jsonld_ActorRdfJoinSelectivity_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata__2_0_0_components_ActorRdfMetadata_jsonld_ActorRdfMetadata_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__2_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse__2_0_0_components_ActorRdfParse_jsonld_ActorRdfParse_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse_html__2_0_0_components_ActorRdfParseHtml_jsonld_ActorRdfParseHtml_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia__2_0_0_components_ActorRdfResolveHypermedia_jsonld_ActorRdfResolveHypermedia_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links__2_0_0_components_ActorRdfResolveHypermediaLinks_jsonld_ActorRdfResolveHypermediaLinks_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links_queue__2_0_0_components_ActorRdfResolveHypermediaLinksQueue_jsonld_ActorRdfResolveHypermediaLinksQueue_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_quad_pattern__2_0_0_components_ActorRdfResolveQuadPattern_jsonld_ActorRdfResolveQuadPattern_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_serialize__2_0_0_components_ActorRdfSerialize_jsonld_ActorRdfSerialize_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_hypermedia__2_0_0_components_ActorRdfUpdateHypermedia_jsonld_ActorRdfUpdateHypermedia_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_quads__2_0_0_components_ActorRdfUpdateQuads_jsonld_ActorRdfUpdateQuads_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__incremunica_bus_guard__1_0_0_components_ActorGuard_jsonld_ActorGuard_default_bus = new ((await import('@comunica/core')).Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@incremunica/bus-guard/^1.0.0/components/ActorGuard.jsonld#ActorGuard_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__incremunica_bus_resource_watch__1_0_0_components_ActorResourceWatch_jsonld_ActorResourceWatch_default_bus = new ((await import('@comunica/core')).Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@incremunica/bus-resource-watch/^1.0.0/components/ActorResourceWatch.jsonld#ActorResourceWatch_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http__2_0_0_components_ActorHttp_jsonld_ActorHttp_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http__2_0_0_components_ActorHttp_jsonld_ActorHttp_fallback_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus = new ((await import('@comunica/bus-query-operation')).BusQueryOperation)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join__2_0_0_components_ActorRdfJoin_jsonld_ActorRdfJoin_default_bus = new ((await import('@comunica/core')).Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http_invalidate__2_0_0_components_ActorHttpInvalidate_jsonld_ActorHttpInvalidate_default_bus = new ((await import('@comunica/core')).Bus)({
...
const urn_comunica_default_context_preprocess_actors_source_to_destination = new ((await import('@comunica/actor-context-preprocess-source-to-destination')).ActorContextPreprocessSourceToDestination)({
...
const urn_comunica_default_context_preprocess_mediators_main = new ((await import('@comunica/mediator-combine-pipeline')).MediatorCombinePipeline)({
  'name': 'urn:comunica:default:context-preprocess/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_context_preprocess__2_0_0_components_ActorContextPreprocess_jsonld_ActorContextPreprocess_default_bus
});
const urn_comunica_default_hash_bindings_actors_sha1 = new ((await import('@comunica/actor-hash-bindings-sha1')).ActorHashBindingsSha1)({
...
const urn_comunica_default_optimize_query_operation_actors_join_bgp = new ((await import('@comunica/actor-optimize-query-operation-join-bgp')).ActorOptimizeQueryOperationJoinBgp)({
...
const urn_comunica_default_optimize_query_operation_actors_bgp_to_join = new ((await import('@comunica/actor-optimize-query-operation-bgp-to-join')).ActorOptimizeQueryOperationBgpToJoin)({
  'name': 'urn:comunica:default:optimize-query-operation/actors#bgp-to-join',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_query_operation__2_0_0_components_ActorOptimizeQueryOperation_jsonld_ActorOptimizeQueryOperation_default_bus
});
const urn_comunica_default_optimize_query_operation_actors_join_connected = new ((await import('@comunica/actor-optimize-query-operation-join-connected')).ActorOptimizeQueryOperationJoinConnected)({
  'name': 'urn:comunica:default:optimize-query-operation/actors#join-connected',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_query_operation__2_0_0_components_ActorOptimizeQueryOperation_jsonld_ActorOptimizeQueryOperation_default_bus
});
const urn_comunica_default_optimize_query_operation_mediators_main = new ((await import('@comunica/mediator-combine-pipeline')).MediatorCombinePipeline)({
  'name': 'urn:comunica:default:optimize-query-operation/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_query_operation__2_0_0_components_ActorOptimizeQueryOperation_jsonld_ActorOptimizeQueryOperation_default_bus
});
const urn_comunica_default_query_parse_actors_sparql = new ((await import('@comunica/actor-query-parse-sparql')).ActorQueryParseSparql)({
...
const urn_comunica_default_query_parse_actors_graphql = new ((await import('@comunica/actor-query-parse-graphql')).ActorQueryParseGraphql)({
  'name': 'urn:comunica:default:query-parse/actors#graphql',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_parse__2_0_0_components_ActorQueryParse_jsonld_ActorQueryParse_default_bus
});
const urn_comunica_default_query_parse_mediators_main = new ((await import('@comunica/mediator-race')).MediatorRace)({
  'name': 'urn:comunica:default:query-parse/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_parse__2_0_0_components_ActorQueryParse_jsonld_ActorQueryParse_default_bus
});
const urn_comunica_default_query_result_serialize_actors_json = new ((await import('@comunica/actor-query-result-serialize-json')).ActorQueryResultSerializeJson)({
...
const urn_comunica_default_query_result_serialize_actors_simple = new ((await import('@comunica/actor-query-result-serialize-simple')).ActorQueryResultSerializeSimple)({
...
const urn_comunica_default_query_result_serialize_actors_csv = new ((await import('@comunica/actor-query-result-serialize-sparql-csv')).ActorQueryResultSerializeSparqlCsv)({
...
const urn_comunica_default_query_result_serialize_actors_sparql_tsv = new ((await import('@comunica/actor-query-result-serialize-sparql-tsv')).ActorQueryResultSerializeSparqlTsv)({
...
const urn_comunica_default_query_result_serialize_actors_sparql_xml = new ((await import('@comunica/actor-query-result-serialize-sparql-xml')).ActorQueryResultSerializeSparqlXml)({
...
const urn_comunica_default_query_result_serialize_actors_table = new ((await import('@comunica/actor-query-result-serialize-table')).ActorQueryResultSerializeTable)({
  'columnWidth': 50,
...
const urn_comunica_default_query_result_serialize_actors_tree = new ((await import('@comunica/actor-query-result-serialize-tree')).ActorQueryResultSerializeTree)({
...
const urn_comunica_default_query_result_serialize_mediators_serialize = new ((await import('@comunica/mediator-race')).MediatorRace)({
  'name': 'urn:comunica:default:query-result-serialize/mediators#serialize',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_result_serialize__2_0_0_components_ActorQueryResultSerialize_jsonld_ActorQueryResultSerialize_default_bus
});
const urn_comunica_default_query_result_serialize_mediators_mediaType = new ((await import('@comunica/mediator-combine-union')).MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': 'urn:comunica:default:query-result-serialize/mediators#mediaType',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_result_serialize__2_0_0_components_ActorQueryResultSerialize_jsonld_ActorQueryResultSerialize_default_bus
});
const urn_comunica_default_query_result_serialize_mediators_mediaTypeFormat = new ((await import('@comunica/mediator-combine-union')).MediatorCombineUnion)({
  'field': 'mediaTypeFormats',
  'name': 'urn:comunica:default:query-result-serialize/mediators#mediaTypeFormat',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_result_serialize__2_0_0_components_ActorQueryResultSerialize_jsonld_ActorQueryResultSerialize_default_bus
});
const urn_comunica_default_dereference_actors_fallback = new ((await import('@comunica/actor-dereference-fallback')).ActorDereferenceFallback)({
...
const urn_comunica_default_dereference_mediators_main = new ((await import('@comunica/mediator-race')).MediatorRace)({
  'name': 'urn:comunica:default:dereference/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_dereference__2_0_0_components_ActorDereference_jsonld_ActorDereference_default_bus
});
const urn_comunica_default_dereference_rdf_mediators_main = new ((await import('@comunica/mediator-race')).MediatorRace)({
...
const urn_comunica_default_rdf_join_entries_sort_actors_cardinality = new ((await import('@comunica/actor-rdf-join-entries-sort-cardinality')).ActorRdfJoinEntriesSortCardinality)({
...
const urn_comunica_default_rdf_join_entries_sort_mediators_main = new ((await import('@comunica/mediator-race')).MediatorRace)({
  'name': 'urn:comunica:default:rdf-join-entries-sort/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join_entries_sort__2_0_0_components_ActorRdfJoinEntriesSort_jsonld_ActorRdfJoinEntriesSort_default_bus
});
const urn_comunica_default_rdf_join_selectivity_actors_variable_counting = new ((await import('@comunica/actor-rdf-join-selectivity-variable-counting')).ActorRdfJoinSelectivityVariableCounting)({
...
const urn_comunica_default_rdf_join_selectivity_mediators_main = new ((await import('@comunica/mediator-number')).MediatorNumber)({
  'field': 'accuracy',
  'type': 'max',
  'ignoreErrors': true,
...
const urn_comunica_default_rdf_metadata_actors_primary_topic = new ((await import('@comunica/actor-rdf-metadata-primary-topic')).ActorRdfMetadataPrimaryTopic)({
...
const urn_comunica_default_rdf_metadata_actors_all = new ((await import('@comunica/actor-rdf-metadata-all')).ActorRdfMetadataAll)({
  'name': 'urn:comunica:default:rdf-metadata/actors#all',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata__2_0_0_components_ActorRdfMetadata_jsonld_ActorRdfMetadata_default_bus
});
const urn_comunica_default_rdf_metadata_mediators_main = new ((await import('@comunica/mediator-race')).MediatorRace)({
  'name': 'urn:comunica:default:rdf-metadata/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata__2_0_0_components_ActorRdfMetadata_jsonld_ActorRdfMetadata_default_bus
});
const urn_comunica_default_rdf_metadata_extract_actors_hydra_controls = new ((await import('@comunica/actor-rdf-metadata-extract-hydra-controls')).ActorRdfMetadataExtractHydraControls)({
...
const urn_comunica_default_rdf_metadata_extract_actors_hydra_count = new ((await import('@comunica/actor-rdf-metadata-extract-hydra-count')).ActorRdfMetadataExtractHydraCount)({
  'predicates': [
...
const urn_comunica_default_rdf_metadata_extract_actors_hydra_pagesize = new ((await import('@comunica/actor-rdf-metadata-extract-hydra-pagesize')).ActorRdfMetadataExtractHydraPagesize)({
  'predicates': [
...
const urn_comunica_default_rdf_metadata_extract_actors_request_time = new ((await import('@comunica/actor-rdf-metadata-extract-request-time')).ActorRdfMetadataExtractRequestTime)({
  'name': 'urn:comunica:default:rdf-metadata-extract/actors#request-time',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__2_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus
});
const urn_comunica_default_rdf_metadata_extract_actors_allow_http_methods = new ((await import('@comunica/actor-rdf-metadata-extract-allow-http-methods')).ActorRdfMetadataExtractAllowHttpMethods)({
  'name': 'urn:comunica:default:rdf-metadata-extract/actors#allow-http-methods',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__2_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus
});
const urn_comunica_default_rdf_metadata_extract_actors_put_accepted = new ((await import('@comunica/actor-rdf-metadata-extract-put-accepted')).ActorRdfMetadataExtractPutAccepted)({
  'name': 'urn:comunica:default:rdf-metadata-extract/actors#put-accepted',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__2_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus
});
const urn_comunica_default_rdf_metadata_extract_actors_patch_sparql_update = new ((await import('@comunica/actor-rdf-metadata-extract-patch-sparql-update')).ActorRdfMetadataExtractPatchSparqlUpdate)({
  'name': 'urn:comunica:default:rdf-metadata-extract/actors#patch-sparql-update',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__2_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus
});
const urn_comunica_default_rdf_metadata_extract_actors_guard_data = new ((await import('@incremunica/actor-rdf-metadata-extract-guard-data')).ActorRdfMetadataExtractGuardData)({
  'name': 'urn:comunica:default:rdf-metadata-extract/actors#guard-data',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__2_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus
});
const urn_comunica_default_rdf_metadata_extract_mediators_main = new ((await import('@comunica/mediator-combine-union')).MediatorCombineUnion)({
  'field': 'metadata',
  'name': 'urn:comunica:default:rdf-metadata-extract/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__2_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus
});
const urn_comunica_default_rdf_parse_actors_n3 = new ((await import('@comunica/actor-rdf-parse-n3')).ActorRdfParseN3)({
...
const urn_comunica_default_rdf_parse_actors_rdfxml = new ((await import('@comunica/actor-rdf-parse-rdfxml')).ActorRdfParseRdfXml)({
...
const urn_comunica_default_rdf_parse_actors_xmlrdfa = new ((await import('@comunica/actor-rdf-parse-xml-rdfa')).ActorRdfParseXmlRdfa)({
...
const urn_comunica_default_rdf_parse_actors_shaclc = new ((await import('@comunica/actor-rdf-parse-shaclc')).ActorRdfParseShaclc)({
...
const urn_comunica_default_rdf_parse_mediators_parse = new ((await import('@comunica/mediator-race')).MediatorRace)({
  'name': 'urn:comunica:default:rdf-parse/mediators#parse',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse__2_0_0_components_ActorRdfParse_jsonld_ActorRdfParse_default_bus
});
const urn_comunica_default_rdf_parse_mediators_mediaType = new ((await import('@comunica/mediator-combine-union')).MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': 'urn:comunica:default:rdf-parse/mediators#mediaType',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse__2_0_0_components_ActorRdfParse_jsonld_ActorRdfParse_default_bus
});
const urn_comunica_default_rdf_parse_actors_html = new ((await import('@comunica/actor-rdf-parse-html')).ActorRdfParseHtml)({
...
const urn_comunica_default_rdf_parse_html_actors_microdata = new ((await import('@comunica/actor-rdf-parse-html-microdata')).ActorRdfParseHtmlMicrodata)({
...
const urn_comunica_default_rdf_parse_html_actors_rdfa = new ((await import('@comunica/actor-rdf-parse-html-rdfa')).ActorRdfParseHtmlRdfa)({
  'name': 'urn:comunica:default:rdf-parse-html/actors#rdfa',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse_html__2_0_0_components_ActorRdfParseHtml_jsonld_ActorRdfParseHtml_default_bus
});
const urn_comunica_default_rdf_resolve_hypermedia_mediators_main = new ((await import('@comunica/mediator-number')).MediatorNumber)({
  'field': 'filterFactor',
  'type': 'max',
  'ignoreErrors': true,
...
const urn_comunica_default_rdf_resolve_hypermedia_links_actors_next = new ((await import('@comunica/actor-rdf-resolve-hypermedia-links-next')).ActorRdfResolveHypermediaLinksNext)({
...
const urn_comunica_default_rdf_resolve_hypermedia_links_mediators_main = new ((await import('@comunica/mediator-race')).MediatorRace)({
  'name': 'urn:comunica:default:rdf-resolve-hypermedia-links/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links__2_0_0_components_ActorRdfResolveHypermediaLinks_jsonld_ActorRdfResolveHypermediaLinks_default_bus
});
const urn_comunica_default_rdf_resolve_hypermedia_links_queue_actors_fifo = new ((await import('@comunica/actor-rdf-resolve-hypermedia-links-queue-fifo')).ActorRdfResolveHypermediaLinksQueueFifo)({
...
const urn_comunica_default_rdf_resolve_hypermedia_links_queue_mediators_main = new ((await import('@comunica/mediator-race')).MediatorRace)({
  'name': 'urn:comunica:default:rdf-resolve-hypermedia-links-queue/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links_queue__2_0_0_components_ActorRdfResolveHypermediaLinksQueue_jsonld_ActorRdfResolveHypermediaLinksQueue_default_bus
});
const urn_comunica_default_rdf_resolve_quad_pattern_actors_rdfjs_streaming_source = new ((await import('@incremunica/actor-rdf-resolve-quad-pattern-rdfjs-streaming-source')).ActorRdfResolveQuadPatternRdfjsStreamingSource)({
  'name': 'urn:comunica:default:rdf-resolve-quad-pattern/actors#rdfjs-streaming-source',
...
const urn_comunica_default_rdf_resolve_quad_pattern_mediators_main = new ((await import('@comunica/mediator-race')).MediatorRace)({
  'name': 'urn:comunica:default:rdf-resolve-quad-pattern/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_quad_pattern__2_0_0_components_ActorRdfResolveQuadPattern_jsonld_ActorRdfResolveQuadPattern_default_bus
});
const urn_comunica_default_rdf_serialize_actors_n3 = new ((await import('@comunica/actor-rdf-serialize-n3')).ActorRdfSerializeN3)({
  'mediaTypePriorities': {"application/n-quads":1,"application/n-triples":0.8,"application/trig":0.95,"text/n3":0.35,"text/turtle":0.6},
  'mediaTypeFormats': {"application/n-quads":"http://www.w3.org/ns/formats/N-Quads","application/n-triples":"http://www.w3.org/ns/formats/N-Triples","application/trig":"http://www.w3.org/ns/formats/TriG","text/n3":"http://www.w3.org/ns/formats/N3","text/turtle":"http://www.w3.org/ns/formats/Turtle"},
...
const urn_comunica_default_rdf_serialize_actors_jsonld = new ((await import('@comunica/actor-rdf-serialize-jsonld')).ActorRdfSerializeJsonLd)({
...
const urn_comunica_default_rdf_serialize_actors_shaclc = new ((await import('@comunica/actor-rdf-serialize-shaclc')).ActorRdfSerializeShaclc)({
  'mediaTypePriorities': {"text/shaclc":1,"text/shaclc-ext":0.5},
  'mediaTypeFormats': {"text/shaclc":"http://www.w3.org/ns/formats/Shaclc","text/shaclc-ext":"http://www.w3.org/ns/formats/ShaclcExtended"},
  'priorityScale': 0.1,
...
const urn_comunica_default_rdf_serialize_mediators_serialize = new ((await import('@comunica/mediator-race')).MediatorRace)({
  'name': 'urn:comunica:default:rdf-serialize/mediators#serialize',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_serialize__2_0_0_components_ActorRdfSerialize_jsonld_ActorRdfSerialize_default_bus
});
const urn_comunica_default_rdf_serialize_mediators_mediaType = new ((await import('@comunica/mediator-combine-union')).MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': 'urn:comunica:default:rdf-serialize/mediators#mediaType',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_serialize__2_0_0_components_ActorRdfSerialize_jsonld_ActorRdfSerialize_default_bus
});
const urn_comunica_default_rdf_serialize_mediators_mediaTypeFormat = new ((await import('@comunica/mediator-combine-union')).MediatorCombineUnion)({
  'field': 'mediaTypeFormats',
  'name': 'urn:comunica:default:rdf-serialize/mediators#mediaTypeFormat',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_serialize__2_0_0_components_ActorRdfSerialize_jsonld_ActorRdfSerialize_default_bus
});
const urn_comunica_default_rdf_update_hypermedia_mediators_main = new ((await import('@comunica/mediator-race')).MediatorRace)({
...
const urn_comunica_default_rdf_update_quads_actors_rdfjs_store = new ((await import('@comunica/actor-rdf-update-quads-rdfjs-store')).ActorRdfUpdateQuadsRdfJsStore)({
...
const urn_comunica_default_rdf_update_quads_mediators_main = new ((await import('@comunica/mediator-race')).MediatorRace)({
  'name': 'urn:comunica:default:rdf-update-quads/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_quads__2_0_0_components_ActorRdfUpdateQuads_jsonld_ActorRdfUpdateQuads_default_bus
});
const urn_comunica_default_guard_mediators_main = new ((await import('@comunica/mediator-number')).MediatorNumber)({
  'field': 'filterFactor',
  'type': 'max',
  'ignoreErrors': true,
  'name': 'urn:comunica:default:guard/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__incremunica_bus_guard__1_0_0_components_ActorGuard_jsonld_ActorGuard_default_bus
});
const urn_comunica_default_resource_watch_mediators_main = new ((await import('@comunica/mediator-number')).MediatorNumber)({
  'field': 'priority',
  'type': 'max',
  'ignoreErrors': true,
  'name': 'urn:comunica:default:resource-watch/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__incremunica_bus_resource_watch__1_0_0_components_ActorResourceWatch_jsonld_ActorResourceWatch_default_bus
});
const urn_comunica_default_http_actors_fetch = new ((await import('@comunica/actor-http-fetch')).ActorHttpFetch)({
...
const urn_comunica_default_http_mediators_no_fallback = new ((await import('@comunica/mediator-number')).MediatorNumber)({
  'field': 'time',
  'type': 'min',
  'ignoreErrors': true,
...
const urn_comunica_default_http_mediators_main = new ((await import('@comunica/mediator-number')).MediatorNumber)({
  'field': 'time',
  'type': 'min',
  'ignoreErrors': true,
...
const urn_comunica_default_query_operation_actors_values = new ((await import('@comunica/actor-query-operation-values')).ActorQueryOperationValues)({
...
const urn_comunica_default_query_operation_mediators_main = new ((await import('@comunica/mediator-number')).MediatorNumber)({
  'field': 'httpRequests',
  'type': 'min',
  'ignoreErrors': true,
...
const urn_comunica_default_rdf_join_mediators_main = new ((await import('@comunica/mediator-join-coefficients-fixed')).MediatorJoinCoefficientsFixed)({
  'cpuWeight': 1,
  'memoryWeight': 1,
  'timeWeight': 10,
  'ioWeight': 100,
...
const urn_comunica_default_http_invalidate_mediators_main = new ((await import('@comunica/mediator-all')).MediatorAll)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_rdf_update_quads_hypermedia__2_0_0_components_ActorRdfUpdateQuadsHypermedia_jsonld_IActorRdfUpdateQuadsHypermediaArgs_default_invalidator = new ((await import('@comunica/bus-http-invalidate')).ActorHttpInvalidateListenable)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_query_result_serialize_sparql_json__2_0_0_components_ActionObserverHttp_jsonld_IActionObserverHttpArgs_default_invalidator = new ((await import('@comunica/bus-http-invalidate')).ActorHttpInvalidateListenable)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_query_result_serialize_stats__2_0_0_components_ActionObserverHttp_jsonld_IActionObserverHttpArgs_default_invalidator = new ((await import('@comunica/bus-http-invalidate')).ActorHttpInvalidateListenable)({
...
const urn_comunica_default_rdf_join_actors_inner_none = new ((await import('@comunica/actor-rdf-join-inner-none')).ActorRdfJoinNone)({
...
const urn_comunica_default_rdf_join_actors_inner_single = new ((await import('@comunica/actor-rdf-join-inner-single')).ActorRdfJoinSingle)({
  'mediatorJoinSelectivity': urn_comunica_default_rdf_join_selectivity_mediators_main,
  'name': 'urn:comunica:default:rdf-join/actors#inner-single',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join__2_0_0_components_ActorRdfJoin_jsonld_ActorRdfJoin_default_bus
});
const urn_comunica_default_rdf_join_actors_inner_multi_empty = new ((await import('@comunica/actor-rdf-join-inner-multi-empty')).ActorRdfJoinMultiEmpty)({
  'mediatorJoinSelectivity': urn_comunica_default_rdf_join_selectivity_mediators_main,
  'name': 'urn:comunica:default:rdf-join/actors#inner-multi-empty',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join__2_0_0_components_ActorRdfJoin_jsonld_ActorRdfJoin_default_bus
});
const urn_comunica_default_rdf_join_actors_inner_incremental_full_hash = new ((await import('@incremunica/actor-rdf-join-inner-incremental-full-hash')).ActorRdfJoinInnerIncrementalFullHash)({
  'mediatorJoinSelectivity': urn_comunica_default_rdf_join_selectivity_mediators_main,
  'name': 'urn:comunica:default:rdf-join/actors#inner-incremental-full-hash',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join__2_0_0_components_ActorRdfJoin_jsonld_ActorRdfJoin_default_bus
});
const urn_comunica_default_rdf_join_actors_incremental_minus_hash = new ((await import('@incremunica/actor-rdf-join-incremental-minus-hash')).ActorRdfJoinIncrementalMinusHash)({
  'mediatorJoinSelectivity': urn_comunica_default_rdf_join_selectivity_mediators_main,
  'name': 'urn:comunica:default:rdf-join/actors#incremental-minus-hash',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join__2_0_0_components_ActorRdfJoin_jsonld_ActorRdfJoin_default_bus
});
const urn_comunica_default_rdf_join_actors_incremental_optional_hash = new ((await import('@incremunica/actor-rdf-join-incremental-optional-hash')).ActorRdfJoinIncrementalOptionalHash)({
  'mediatorJoinSelectivity': urn_comunica_default_rdf_join_selectivity_mediators_main,
  'name': 'urn:comunica:default:rdf-join/actors#incremental-optional-hash',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join__2_0_0_components_ActorRdfJoin_jsonld_ActorRdfJoin_default_bus
});
const urn_comunica_default_dereference_rdf_actors_parse = new ((await import('@comunica/actor-dereference-rdf-parse')).ActorDereferenceRdfParse)({
...
const urn_comunica_default_rdf_parse_html_actors_script = new ((await import('@comunica/actor-rdf-parse-html-script')).ActorRdfParseHtmlScript)({
...
const urn_comunica_default_rdf_resolve_quad_pattern_actors_incremental_federated = new ((await import('@incremunica/actor-rdf-resolve-quad-pattern-incremental-federated')).ActorRdfResolveQuadPatternIncrementalFederated)({
  'mediatorResolveQuadPattern': urn_comunica_default_rdf_resolve_quad_pattern_mediators_main,
  'skipEmptyPatterns': false,
  'name': 'urn:comunica:default:rdf-resolve-quad-pattern/actors#incremental-federated',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_quad_pattern__2_0_0_components_ActorRdfResolveQuadPattern_jsonld_ActorRdfResolveQuadPattern_default_bus
});
const urn_comunica_default_query_operation_actors_quadpattern = new ((await import('@incremunica/actor-query-operation-incremental-quadpattern')).ActorQueryOperationQuadpattern)({
  'mediatorResolveQuadPattern': urn_comunica_default_rdf_resolve_quad_pattern_mediators_main,
  'unionDefaultGraph': false,
  'name': 'urn:comunica:default:query-operation/actors#quadpattern',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_result_serialize_actors_rdf = new ((await import('@comunica/actor-query-result-serialize-rdf')).ActorQueryResultSerializeRdf)({
...
const urn_comunica_default_rdf_resolve_hypermedia_actors_stream_none = new ((await import('@incremunica/actor-rdf-resolve-hypermedia-stream-none')).ActorRdfResolveHypermediaStreamNone)({
  'mediatorGuard': urn_comunica_default_guard_mediators_main,
  'name': 'urn:comunica:default:rdf-resolve-hypermedia/actors#stream-none',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia__2_0_0_components_ActorRdfResolveHypermedia_jsonld_ActorRdfResolveHypermedia_default_bus
});
const urn_comunica_default_guard_actors_naive = new ((await import('@incremunica/actor-guard-naive')).ActorGuardNaive)({
  'mediatorResourceWatch': urn_comunica_default_resource_watch_mediators_main,
  'mediatorDereferenceRdf': urn_comunica_default_dereference_rdf_mediators_main,
  'name': 'urn:comunica:default:guard/actors#naive',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__incremunica_bus_guard__1_0_0_components_ActorGuard_jsonld_ActorGuard_default_bus
});
const urn_comunica_default_http_actors_wayback = new ((await import('@comunica/actor-http-wayback')).ActorHttpWayback)({
  'mediatorHttp': urn_comunica_default_http_mediators_no_fallback,
  'name': 'urn:comunica:default:http/actors#wayback',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http__2_0_0_components_ActorHttp_jsonld_ActorHttp_fallback_bus
});
const urn_comunica_default_rdf_parse_actors_jsonld = new ((await import('@comunica/actor-rdf-parse-jsonld')).ActorRdfParseJsonLd)({
...
const urn_comunica_default_rdf_update_hypermedia_actors_patch_sparql_update = new ((await import('@comunica/actor-rdf-update-hypermedia-patch-sparql-update')).ActorRdfUpdateHypermediaPatchSparqlUpdate)({
  'mediatorHttp': urn_comunica_default_http_mediators_main,
  'name': 'urn:comunica:default:rdf-update-hypermedia/actors#patch-sparql-update',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_hypermedia__2_0_0_components_ActorRdfUpdateHypermedia_jsonld_ActorRdfUpdateHypermedia_default_bus
});
const urn_comunica_default_rdf_update_hypermedia_actors_put_ldp = new ((await import('@comunica/actor-rdf-update-hypermedia-put-ldp')).ActorRdfUpdateHypermediaPutLdp)({
  'mediatorHttp': urn_comunica_default_http_mediators_main,
...
const urn_comunica_default_rdf_update_hypermedia_actors_sparql = new ((await import('@comunica/actor-rdf-update-hypermedia-sparql')).ActorRdfUpdateHypermediaSparql)({
  'mediatorHttp': urn_comunica_default_http_mediators_main,
...
const urn_comunica_default_resource_watch_actors_polling = new ((await import('@incremunica/actor-resource-watch-polling')).ActorResourceWatchPolling)({
  'mediatorHttp': urn_comunica_default_http_mediators_main,
  'defaultPollingFrequency': 1,
  'priority': 5,
  'name': 'urn:comunica:default:resource-watch/actors#polling',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__incremunica_bus_resource_watch__1_0_0_components_ActorResourceWatch_jsonld_ActorResourceWatch_default_bus
});
const urn_comunica_default_resource_watch_actors_solid_notification_websockets = new ((await import('@incremunica/actor-resource-watch-solid-notification-websockets')).ActorResourceWatchSolidNotificationWebsockets)({
  'mediatorHttp': urn_comunica_default_http_mediators_main,
  'priority': 10,
  'name': 'urn:comunica:default:resource-watch/actors#solid-notification-websockets',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__incremunica_bus_resource_watch__1_0_0_components_ActorResourceWatch_jsonld_ActorResourceWatch_default_bus
});
const urn_comunica_default_query_operation_actors_project = new ((await import('@comunica/actor-query-operation-project')).ActorQueryOperationProject)({
...
const urn_comunica_default_query_operation_actors_filter = new ((await import('@incremunica/actor-query-operation-incremental-filter')).ActorQueryOperationIncrementalFilter)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#filter',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_union = new ((await import('@comunica/actor-query-operation-union')).ActorQueryOperationUnion)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#union',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_path_alt = new ((await import('@comunica/actor-query-operation-path-alt')).ActorQueryOperationPathAlt)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#path-alt',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_path_inv = new ((await import('@comunica/actor-query-operation-path-inv')).ActorQueryOperationPathInv)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#path-inv',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_path_link = new ((await import('@comunica/actor-query-operation-path-link')).ActorQueryOperationPathLink)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#path-link',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_path_nps = new ((await import('@comunica/actor-query-operation-path-nps')).ActorQueryOperationPathNps)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#path-nps',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_path_one_or_more = new ((await import('@comunica/actor-query-operation-path-one-or-more')).ActorQueryOperationPathOneOrMore)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#path-one-or-more',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_path_zero_or_more = new ((await import('@comunica/actor-query-operation-path-zero-or-more')).ActorQueryOperationPathZeroOrMore)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#path-zero-or-more',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_path_zero_or_one = new ((await import('@comunica/actor-query-operation-path-zero-or-one')).ActorQueryOperationPathZeroOrOne)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#path-zero-or-one',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_update_add = new ((await import('@comunica/actor-query-operation-update-add-rewrite')).ActorQueryOperationAddRewrite)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#update-add',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_update_clear = new ((await import('@comunica/actor-query-operation-update-clear')).ActorQueryOperationClear)({
...
const urn_comunica_default_query_operation_actors_update_composite = new ((await import('@comunica/actor-query-operation-update-compositeupdate')).ActorQueryOperationUpdateCompositeUpdate)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#update-composite',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_update_copy = new ((await import('@comunica/actor-query-operation-update-copy-rewrite')).ActorQueryOperationCopyRewrite)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#update-copy',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_update_create = new ((await import('@comunica/actor-query-operation-update-create')).ActorQueryOperationCreate)({
  'mediatorUpdateQuads': urn_comunica_default_rdf_update_quads_mediators_main,
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#update-create',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_update_delete_insert = new ((await import('@comunica/actor-query-operation-update-deleteinsert')).ActorQueryOperationUpdateDeleteInsert)({
  'mediatorUpdateQuads': urn_comunica_default_rdf_update_quads_mediators_main,
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#update-delete-insert',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_update_drop = new ((await import('@comunica/actor-query-operation-update-drop')).ActorQueryOperationDrop)({
  'mediatorUpdateQuads': urn_comunica_default_rdf_update_quads_mediators_main,
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#update-drop',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_update_load = new ((await import('@comunica/actor-query-operation-update-load')).ActorQueryOperationLoad)({
  'mediatorUpdateQuads': urn_comunica_default_rdf_update_quads_mediators_main,
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#update-load',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_update_move = new ((await import('@comunica/actor-query-operation-update-move-rewrite')).ActorQueryOperationMoveRewrite)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#update-move',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_join = new ((await import('@comunica/actor-query-operation-join')).ActorQueryOperationJoin)({
  'mediatorJoin': urn_comunica_default_rdf_join_mediators_main,
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#join',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_minus = new ((await import('@comunica/actor-query-operation-minus')).ActorQueryOperationMinus)({
  'mediatorJoin': urn_comunica_default_rdf_join_mediators_main,
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#minus',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_leftjoin = new ((await import('@comunica/actor-query-operation-leftjoin')).ActorQueryOperationLeftJoin)({
  'mediatorJoin': urn_comunica_default_rdf_join_mediators_main,
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#leftjoin',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_query_operation_actors_path_seq = new ((await import('@comunica/actor-query-operation-path-seq')).ActorQueryOperationPathSeq)({
  'mediatorJoin': urn_comunica_default_rdf_join_mediators_main,
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#path-seq',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus
});
const urn_comunica_default_rdf_join_actors_inner_multi_smallest = new ((await import('@comunica/actor-rdf-join-inner-multi-smallest')).ActorRdfJoinMultiSmallest)({
...
const urn_comunica_default_dereference_actors_http = new ((await import('@comunica/actor-dereference-http')).ActorDereferenceHttp)({
  'mediatorHttp': urn_comunica_default_http_mediators_main,
...
const urn_comunica_default_http_actors_proxy = new ((await import('@comunica/actor-http-proxy')).ActorHttpProxy)({
  'mediatorHttp': urn_comunica_default_http_mediators_main,
...
const urn_comunica_default_init_actors_query = new ((await import('@comunica/actor-init-query')).ActorInitQuery)({
...
const urn_comunica_default_rdf_resolve_quad_pattern_actors_hypermedia = new ((await import('@comunica/actor-rdf-resolve-quad-pattern-hypermedia')).ActorRdfResolveQuadPatternHypermedia)({
  'cacheSize': 100,
...
const urn_comunica_default_rdf_update_quads_actors_hypermedia = new ((await import('@comunica/actor-rdf-update-quads-hypermedia')).ActorRdfUpdateQuadsHypermedia)({
  'cacheSize': 100,
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_query_result_serialize_stats__2_0_0_components_ActorQueryResultSerializeStats_jsonld_ActorQueryResultSerializeStats_default_observer = new ((await import('@comunica/actor-query-result-serialize-stats')).ActionObserverHttp)({
...
const urn_comunica_default_query_result_serialize_actors_sparql_json = new ((await import('@comunica/actor-query-result-serialize-sparql-json')).ActorQueryResultSerializeSparqlJson)({
  'emitMetadata': true,
...
const urn_comunica_default_query_result_serialize_actors_stats = new ((await import('@comunica/actor-query-result-serialize-stats')).ActorQueryResultSerializeStats)({
...
const urn_comunica_default_rdf_resolve_quad_pattern_actors_rdfjs_source = new ((await import('@comunica/actor-rdf-resolve-quad-pattern-rdfjs-source')).ActorRdfResolveQuadPatternRdfJsSource)({
...
const urn_comunica_default_Runner = (https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_init__2_0_0_components_ActorInit_jsonld_ActorInit_default_bus, [
  ...
  urn_comunica_default_rdf_metadata_extract_actors_guard_data,
  ...
  urn_comunica_default_rdf_resolve_hypermedia_actors_stream_none,
  ...
  urn_comunica_default_rdf_resolve_quad_pattern_actors_hypermedia,
  urn_comunica_default_rdf_resolve_quad_pattern_actors_incremental_federated,
  urn_comunica_default_rdf_resolve_quad_pattern_actors_rdfjs_streaming_source,
  ...
  urn_comunica_default_guard_actors_naive,
  urn_comunica_default_resource_watch_actors_polling,
  urn_comunica_default_resource_watch_actors_solid_notification_websockets,
  ...
  urn_comunica_default_rdf_join_actors_inner_incremental_full_hash,
  urn_comunica_default_rdf_join_actors_incremental_minus_hash,
  urn_comunica_default_rdf_join_actors_incremental_optional_hash
]);
export default urn_comunica_default_init_actors_query;
